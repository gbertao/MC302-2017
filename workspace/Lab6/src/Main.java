...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("A operação demorou: " + (System.nanoTime() - s) / 1000000 + " ms");
		...
		System.out.println("A operação demorou: " + (System.nanoTime() - l) / 1000000 + " ms");
		...
		System.out.println("A operação demorou: "+ (System.nanoTime() - g) / 1000000 + " ms");
		...
		System.out.println("A operação demorou: "+ (System.nanoTime() - t) / 1000000 + " ms");
		...
		System.out.println("A operação demorou: "+ tempo / 1000000 + " ms");
