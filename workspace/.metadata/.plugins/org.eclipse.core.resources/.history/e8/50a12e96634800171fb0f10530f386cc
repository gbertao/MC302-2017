...
public class Main {
	...
	private static void umaPartida(Baralho baralho1, Baralho baralho2, int verbosidade, int tempoLimite, PrintWriter saidaArquivo, EnumSet<Funcionalidade> funcionalidades){
		...
		Motor partida = new MotorRA173325(baralho1, baralho2, Mao1, Mao2, jogA, jogB, verbosidade, tempoLimite, saidaArquivo, funcionalidades);
	...
	private static void multiplasPartidas(Baralho baralho1, Baralho baralho2, int verbosidade, int tempoLimite, PrintWriter saidaArquivo, EnumSet<Funcionalidade> funcionalidades, int n){
		...
		for(int p = 0; p < 2; p++){
			for(int w = 0; w < n/2; w++){
				...
				Motor partida;
				if(moeda)
					partida = new MotorRA173325(deck1, deck2, Mao1, Mao2, jogA, jogB, verbosidade, tempoLimite, saidaArquivo, funcionalidades);
				else
					partida = new MotorRA173325(deck2, deck1, Mao2, Mao1, jogB, jogA, verbosidade, tempoLimite, saidaArquivo, funcionalidades);
